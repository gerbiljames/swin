...
class fwSettings(object):
    ...
    # Added in for Pi Swarm simulator
    headless = False
    experiment = False
    taxis_algorithm = "beta"
    beta = 2  # beta is in robots
    omega = 30  # omega is in seconds
    wireless_range = 50  # wireless_range is in cm
    robots = 20  # robots is in robots (obviously)
    log_advanced = False  # creates logs with more juicy data, implies --experiment
    seed = None  # sets the random seed used for the run
